...
A simple financial Q&A chatbot powered by Flask + Ollama (local LLM).
It can answer finance, reasoning, and stock-market questions — including Apple stock analysis.
...
2. Setup Steps
Step 1 — Open folder in VS Code or Terminal
cd "C:\Users\<YourName>\finchatgpt"
...
4. Troubleshooting
Problem	Solution
⚠️ “Ollama port already in use”	Close all Ollama windows → open a new terminal → ollama serve again
❌ “127.0.0.1 refused to connect”	Make sure Flask app is running (python app.py)
🧠 “Model requires more memory”	Use lighter model ollama pull gemma:2b
⏳ “No response”	Restart Ollama service & rerun Flask app
🔒 “Username already exists”	Use a different username on registration
